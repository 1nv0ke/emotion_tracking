...
def detectBlob(imgname):
	...
	cv2.line(imgout, (0, UPPER_BOUND), (2047, UPPER_BOUND), (255, 0, 0))
        ...
        pos = (int(kp[0].pt[0]), int(kp[0].pt[1]))
        cv2.putText(imgin, "%.2f" % temp_f, pos, cv2.FONT_HERSHEY_SIMPLEX, 2, (255,255,0))
...
if __name__ == '__main__':
    ...
    # folder_path = '/media/seven/MyPassport/emt_data/04282017/single/01/'
    # info_pickle_fname = 'single_1_'
    # l_or_r = '1'
